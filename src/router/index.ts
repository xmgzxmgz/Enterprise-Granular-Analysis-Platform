    ...
    children: [
      {
        ...
        children: [
            ...
            children: [
              {
                path: '两用物项',
                name: '两用物项',
                component: () => import('@/views/Theme/SensitiveItems/DualUse.vue'),
          ...
          },
          {
            ...
            meta: { breadcrumb: ['分类主题管理', '企业出口风险分类', '重点物品'] },
            children: [
              {
                path: '冷冻水产品',
                name: '冷冻水产品',
                component: () => import('@/views/Theme/KeyItems/FrozenFish.vue'),
                meta: { breadcrumb: ['分类主题管理', '企业出口风险分类', '重点物品', '冷冻水产品'] }
              }
            ]
          },
          {
            ...
            children: [
              {
                path: '数频分配',
                name: '数频分配',
                component: () => import('@/views/Theme/CrossBorder/FrequencyAssign.vue'),
                meta: { breadcrumb: ['分类主题管理', '企业出口风险分类', '跨境电商出口敏感指标数频分配', '数频分配'] }
              }
            ]
          }
        ]
